// Exercise 14
var guest_list = ['Umer', ' Ahed', 'Shafey', 'Sana'];
for (var i = 0; i < guest_list.length; i++) {
    console.log('Respected Sir/Madam  ' + guest_list[i] + ',\n  We invited you on dinner tomorrow. \n\n Thank.u \n ');
}
;
// Exercise 15
var not_present = 'Shafey';
var new_guest = 'Shahryar';
guest_list[2] = new_guest;
for (var i = 0; i < guest_list.length; i++) {
    console.log('Respected Sir/Madam  ' + guest_list[i] + ',\n  We invited you on dinner tomorrow. \n\n Thank.u \n ');
}
console.log("Mr. ".concat(not_present, " will not coming tomorrw dinner \n"));
// Exercise 16
...
while (guest_list.length > 2) {
    ...
    console.log("Soory Mr/Mrs ".concat(remove_guest, " you are not invited for dinner."));
}
for (var i = 0; i < guest_list.length; i++) {
